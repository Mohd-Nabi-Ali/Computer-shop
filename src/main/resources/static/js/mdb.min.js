jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    return function (t, e, i, n) {
        ...
        function l(t) {
            if (t) {
                var e = (new Date).getTime(), i = g.State.calls.length;
                ...
                for (var o = 0; i > o; o++) if (g.State.calls[o]) {
                    var r = g.State.calls[o], s = r[0], d = r[2], h = r[3], f = !!h, m = null;
                    ...
                    for (var v = Math.min((e - h) / d.duration, 1), b = 0, x = s.length; x > b; b++) {
                        ...
                        if (a(C)) {
                            ...
                            for (var M in d.visibility !== n && "hidden" !== d.visibility && y.setPropertyValue(C, "visibility", d.visibility), k) if ("element" !== M) {
                                var T, O = k[M], _ = p.isString(O.easing) ? g.Easings[O.easing] : O.easing;
                                if (1 === v) T = O.endValue; else {
                                    var P = O.endValue - O.startValue;
                                    if (T = O.startValue + P * _(v, d, P), !f && T === O.currentValue) continue
                                }
                                if (O.currentValue = T, "tween" === M) m = T; else {
                                    if (y.Hooks.registered[M]) {
                                        var A = y.Hooks.getRoot(M), I = a(C).rootPropertyValueCache[A];
        ...
        function c(t, e) {
            ...
            for (var i = g.State.calls[t][0], o = g.State.calls[t][1], r = g.State.calls[t][2], s = g.State.calls[t][4], l = !1, c = 0, d = i.length; d > c; c++) {
                ...
                }), g(h, "reverse", {loop: !0, delay: r.delay})), !1 !== r.queue && u.dequeue(h, r.queue)
            }
            g.State.calls[t] = !1;
            for (var f = 0, m = g.State.calls.length; m > f; f++) if (!1 !== g.State.calls[f]) {
                l = !0;
                break
            }
        ...
        if (!(7 >= d)) {
            ...
            var y = g.CSS = {
                ...
                Hooks: {
                    templates: {
                        ...
                        var i, n, o;
                        if (d) for (i in y.Hooks.templates) {
                        ...
                        for (t = 0; t < y.Lists.colors.length; t++) !function () {
                            ...
                            y.Normalizations.registered[e] = function (t, i, o) {
                                switch (t) {
                                    ...
                                    case"extract":
                                        var a;
                                        if (y.RegEx.wrappedValueAlreadyExtracted.test(o)) a = o; else {
                                            var r, s = {
                                                black: "rgb(0, 0, 0)",
                                                blue: "rgb(0, 0, 255)",
                ...
                getPropertyValue: function (t, i, o, r) {
                    ...
                    if (!/^[\d-]/.test(l)) if (a(t) && a(t).isSVG && y.Names.SVGAttribute(i)) if (/^(height|width)$/i.test(i)) try {
                        l = t.getBBox()[i]
                    } catch (t) {
                        l = 0
                ...
                setPropertyValue: function (t, i, n, o, r) {
                    var s = i;
                    if ("scroll" === i) r.container ? r.container["scroll" + r.direction] = n : "Left" === r.direction ? e.scrollTo(n, r.alternateValue) : e.scrollTo(r.alternateValue, n); else if (y.Normalizations.registered[i] && "transform" === y.Normalizations.registered[i]("name", t)) y.Normalizations.registered[i]("inject", t, n), s = "transform", n = a(t).transformCache[i]; else {
                        if (y.Hooks.registered[i]) {
            ...
            y.Hooks.register(), y.Normalizations.register(), g.hook = function (t, e, i) {
                ...
                return t = o(t), u.each(t, function (t, o) {
                    if (a(o) === n && g.init(o), i === n) r === n && (r = g.CSS.getPropertyValue(o, e)); else {
            ...
            var x = function () {
                ...
                function r() {
                    function t(t) {
                        ...
                        function m() {
                            ...
                            var s = 100, l = {};
                            if (o && n) l.emToPx = E.lastEmToPx, l.percentToPxWidth = E.lastPercentToPxWidth, l.percentToPxHeight = E.lastPercentToPxHeight; else {
                        ...
                        if ("scroll" === T) {
                            var x, k, M, _ = /^x$/i.test(c.axis) ? "Left" : "Top", P = parseFloat(c.offset) || 0;
                            c.container ? p.isWrapped(c.container) || p.isNode(c.container) ? (c.container = c.container[0] || c.container, M = (x = c.container["scroll" + _]) + u(r).position()[_.toLowerCase()] + P) : c.container = null : (x = g.State.scrollAnchor[g.State["scrollProperty" + _]], k = g.State.scrollAnchor[g.State["scrollProperty" + ("Left" === _ ? "Top" : "Left")]], M = u(r).offset()[_.toLowerCase()] + P), d = {
                                scroll: {
                                    ...
                                    unitType: "",
                                    easing: c.easing,
                                    scrollData: {container: c.container, direction: _, alternateValue: k}
                                }, element: r
                            ...
                            for (var D in a(r).tweensContainer && !0 === a(r).isAnimating && (A = a(r).tweensContainer), u.each(b, function (t, e) {
                                ...
                                var F = h(b[D]), R = F[0], W = F[1], V = F[2];
                                D = y.Names.camelCase(D);
                                var H = y.Hooks.getRoot(D), z = !1;
                                if (a(r).isSVG || "tween" === H || !1 !== y.Names.prefixCheck(H)[1] || y.Normalizations.registered[H] !== n) {
                                    ...
                                    if (V = (N = f(D, V))[0], j = N[1], R = (N = f(D, R))[0].replace(/^([+-\/*])=/, function (t, e) {
                                        return Y = e, ""
                                    }), B = N[1], V = parseFloat(V) || 0, R = parseFloat(R) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(D) ? (R /= 100, B = "em") : /^scale/.test(D) ? (R /= 100, B = "") : /(Red|Green|Blue)$/i.test(D) && (R = R / 100 * 255, B = "")), /[\/*]/.test(Y)) B = j; else if (j !== B && 0 !== V) if (0 === R) B = j; else {
                                        o = o || m();
                    ...
                    var o, r = this, c = u.extend({}, g.defaults, w), d = {};
                ...
                if (p.isWrapped(this) ? (d = !1, f = 0, v = this, h = this) : (d = !0, f = 1, v = k ? arguments[0].elements || arguments[0].e : arguments[0]), v = o(v)) {
                    ...
                    var T, O = {promise: null, resolver: null, rejecter: null};
                        ...
                        default:
                            if (!u.isPlainObject(b) || p.isEmptyObject(b)) {
                                if (p.isString(b) && g.Redirects[b]) {
                                    var P = (D = u.extend({}, w)).duration, A = D.delay || 0;
                    ...
                    if (u.each(v, function (t, e) {
                        p.isNode(e) && r.call(e)
                    }), (D = u.extend({}, g.defaults, w)).loop = parseInt(D.loop), $ = 2 * D.loop - 1, D.loop) for (var F = 0; $ > F; F++) {
        ...
        1: [function (t, e, i) {
            ...
            n._set("doughnut", {
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    dataElementType: o.Arc, linkScales: a.noop, getRingIndex: function (t) {
                        ...
                        if (p < 2 * Math.PI) {
                            var f = o.rotation % (2 * Math.PI),
                                ...
                                v = {x: Math.cos(f), y: Math.sin(f)}, g = {x: Math.cos(m), y: Math.sin(m)},
                        ...
                        var n = this, o = n.chart, r = o.chartArea, s = o.options, l = s.animation,
                            ...
                            m = i && l.animateScale ? 0 : n.innerRadius, v = i && l.animateScale ? 0 : n.outerRadius,
                        ...
                        var b = t._model, y = t.custom || {}, x = a.valueAtIndexOrDefault,
            ...
            n._set("line", {
                ...
                t.controllers.line = t.DatasetController.extend({
                    datasetElementType: o.Line, dataElementType: o.Point, update: function (t) {
                        ...
                        var t, i = this.chart, n = this.getMeta(), o = n.data || [], r = i.chartArea, s = o.length,
                            l = 0;
            ...
            n._set("polarArea", {
                ...
                t.controllers.polarArea = t.DatasetController.extend({
                    dataElementType: o.Arc, linkScales: a.noop, update: function (t) {
                        var e, i, n, o = this, r = o.getDataset(), s = o.getMeta(), l = o.chart.options.startAngle || 0,
                        ...
                        var n = this, o = n.chart, r = n.getDataset(), s = o.options, l = s.animation, c = o.scale,
                            u = o.data.labels, d = c.xCenter, h = c.yCenter, p = s.startAngle,
                            f = t.hidden ? 0 : c.getDistanceFromCenterForValue(r.data[e]), m = n._starts[e],
                        ...
                        var b = this.chart.options.elements.arc, y = t.custom || {}, x = a.valueAtIndexOrDefault,
                            w = t._model;
            ...
            n._set("radar", {scale: {type: "radialLinear"}, elements: {line: {tension: 0}}}), e.exports = function (t) {
                t.controllers.radar = t.DatasetController.extend({
                    datasetElementType: o.Line, dataElementType: o.Point, linkScales: a.noop, update: function (t) {
            ...
            "use strict";
            var n = t(22), o = t(23), a = t(26), r = t(46), s = t(29), l = t(31), c = t(49), u = t(32), d = t(34),
                h = t(36);
            e.exports = function (t) {
                function e(t) {
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, r.extend(t.prototype, {
                    construct: function (e, i) {
                        ...
                        var t = this, i = t.options, n = t.scales || {}, o = [],
            ...
            e.exports = function () {
                ...
                function i(i, n, o) {
                    var r = document.defaultView, s = a._getParentNode(i), l = r.getComputedStyle(i)[n],
                        c = r.getComputedStyle(s)[n], u = e(l), d = e(c), h = Number.POSITIVE_INFINITY;
                ...
                a.configMerge = function () {
                    ...
                    var i, n, o = t.originalEvent || t, r = t.target || t.srcElement, s = r.getBoundingClientRect(),
                        l = o.touches;
                ...
                defaults: {}, addBox: function (t, e) {
                    ...
                    if (t) {
                        var r = t.options.layout || {}, s = n.options.toPadding(r.padding), l = s.left, c = s.right,
                            ...
                            f = o(t.boxes, "top"), m = o(t.boxes, "bottom"), v = o(t.boxes, "chartArea");
                        a(h, !0), a(p, !1), a(f, !0), a(m, !1);
                        var g = e - l - c, b = i - u - d, y = b / 2, x = (e - g / 2) / (h.length + p.length),
                            w = (i - y) / (f.length + m.length), k = g, C = b, S = [];
            ...
            n._set("scale", {
                ...
                fit: function () {
                    var t = this, e = t.minSize = {width: 0, height: 0}, i = s(t._ticks), n = t.options, o = n.ticks,
                        r = n.scaleLabel, l = n.gridLines, h = n.display, p = t.isHorizontal(), f = u(o),
                    ...
                    if (o.display && h) {
                        var g = a.longestText(t.ctx, f.font, i, t.longestTextCache), b = a.numberOfLabelLines(i),
                            y = .5 * f.size, x = t.options.ticks.padding;
                        if (p) {
                            ...
                            var S = c(t.ctx, i[0], f.font), M = c(t.ctx, i[i.length - 1], f.font);
                ...
                draw: function (t) {
                    ...
                    if (i.display) {
                        var o = e.ctx, r = n.global, s = i.ticks.minor, c = i.ticks.major || s, h = i.gridLines,
                            p = i.scaleLabel, f = 0 !== e.labelRotation, m = e.isHorizontal(),
                            v = s.autoSkip ? e._autoSkip(e.getTicks()) : e.getTicks(),
                            g = a.valueOrDefault(s.fontColor, r.defaultFontColor), b = u(s),
                            y = a.valueOrDefault(c.fontColor, r.defaultFontColor), x = u(c),
                            w = h.drawTicks ? h.tickMarkLength : 0,
                            k = a.valueOrDefault(p.fontColor, r.defaultFontColor), C = u(p),
                            S = a.options.toPadding(p.padding), M = a.toRadians(e.labelRotation), T = [],
                            O = e.options.gridLines.lineWidth, _ = "right" === i.position ? e.left : e.right - O - w,
                        ...
                        if (a.each(v, function (n, o) {
                            if (!a.isNullOrUndef(n.label)) {
                                ...
                                var F = "middle", R = "middle", W = s.padding;
                                if (m) {
                                    var V = w + W;
                            ...
                            if (h.display && (o.save(), o.lineWidth = t.glWidth, o.strokeStyle = t.glColor, o.setLineDash && (o.setLineDash(t.glBorderDash), o.lineDashOffset = t.glBorderDashOffset), o.beginPath(), h.drawTicks && (o.moveTo(t.tx1, t.ty1), o.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (o.moveTo(t.x1, t.y1), o.lineTo(t.x2, t.y2)), o.stroke(), o.restore()), s.display) {
                                ...
                                var i = t.label;
                                if (a.isArray(i)) for (var n = i.length, r = 1.5 * b.size, l = e.isHorizontal() ? 0 : -r * (n - 1) / 2, c = 0; c < n; ++c) o.fillText("" + i[c], 0, l), l += r; else o.fillText(i, 0, 0);
                                o.restore()
                            }
                        }), p.display) {
                            var $, D, E = 0, L = d(p) / 2;
                            if (m) $ = e.left + (e.right - e.left) / 2, D = "bottom" === i.position ? e.bottom - L - S.bottom : e.top + L + S.top; else {
                        ...
                        if (h.drawBorder) {
                            ...
                            var R = e.left, W = e.right + O, V = e.top, H = e.bottom + O, z = a.aliasPixel(o.lineWidth);
            ...
            (e.exports = o.extend({
                initialize: function () {
                    ...
                    var t = this._options.callbacks, e = t.beforeTitle.apply(this, arguments),
                        i = t.title.apply(this, arguments), n = t.afterTitle.apply(this, arguments), o = [];
                    ...
                    var t = this._options.callbacks, e = t.beforeFooter.apply(this, arguments),
                        i = t.footer.apply(this, arguments), n = t.afterFooter.apply(this, arguments), o = [];
                    return o = l(o, c(e)), o = l(o, c(i)), o = l(o, c(n))
                }, update: function (t) {
                    var e, i, n, o, s, l, c, d = this, h = d._options, p = d._model, f = d._model = u(h), m = d._active,
                        v = d._data, g = {xAlign: p.xAlign, yAlign: p.yAlign}, b = {x: p.x, y: p.y},
                        y = {width: p.width, height: p.height}, x = {x: p.caretX, y: p.caretY};
                    if (m.length) {
                        f.opacity = 1;
                        var w = [], k = [];
                        ...
                        h.filter && (C = C.filter(function (t) {
                            ...
                            var o = t.x, a = t.y, r = t.caretSize, s = t.caretPadding, l = t.cornerRadius, c = i.xAlign,
                                u = i.yAlign, d = r + s, h = l + s;
                    ...
                    var n, o, a, r, s, l, c = i.caretSize, u = i.cornerRadius, d = i.xAlign, h = i.yAlign, p = t.x,
                        f = t.y, m = e.width, v = e.height;
                    if ("center" === h) s = f + v / 2, "left" === d ? (o = (n = p) - c, a = n, r = s + c, l = s - c) : (o = (n = p + m) + c, a = n, r = s - c, l = s + c); else if ("left" === d ? (n = (o = p + u + c) - c, a = o + c) : "right" === d ? (n = (o = p + m - u - c) - c, a = o + c) : (n = (o = i.caretX) - c, a = o + c), "top" === h) s = (r = f) - c, l = r; else {
                        s = (r = f + v) + c, l = r;
                        var g = a;
                        a = n, n = g
                    }
            ...
            n._set("global", {
                ...
                inRange: function (t, e) {
                    ...
                    var e = this._view, i = this._model, o = this._chart.ctx, s = e.pointStyle, l = e.rotation,
                        c = e.radius, u = e.x, d = e.y;
            ...
            n._set("global", {
                ...
                draw: function () {
                    ...
                    var v = [[t, n], [t, i], [e, i], [e, n]], g = ["bottom", "left", "top", "right"].indexOf(r, 0);
            ...
            function m(t, e, i) {
                var c, u, d, p, m = t[o] || (t[o] = {}), v = m.resizer = function (t) {
                ...
                id: "filler", afterDatasetsUpdate: function (t, e) {
                    ...
                    if (i) {
                        ...
                        c && u && l.length && (a.canvas.clipArea(o, t.chartArea), function (t, e, i, n, o, a) {
                            var r, s, l, c, u, p, f, m = e.length, v = n.spanGaps, g = [], b = [], y = 0, x = 0;
            ...
            var c = o.extend({
                initialize: function (t) {
                    ...
                    var t = this, e = t.options, i = e.labels, o = e.display, r = t.ctx, s = n.global,
                        ...
                        p = a.fontString(u, d, h), f = t.legendHitBoxes = [], m = t.minSize, v = t.isHorizontal();
                    if (v ? (m.width = t.maxWidth, m.height = o ? 10 : 0) : (m.width = o ? 10 : 0, m.height = t.maxHeight), o) if (r.font = p, v) {
                        var g = t.lineWidths = [0], b = t.legendItems.length ? u + i.padding : 0;
                        ...
                        var y = i.padding, x = t.columnWidths = [], w = i.padding, k = 0, C = 0, S = u + y;
                    ...
                    if (e.display) {
                        var u, d = t.ctx, h = a.valueOrDefault, p = h(i.fontColor, o.defaultFontColor),
                            ...
                            v = h(i.fontFamily, o.defaultFontFamily), g = a.fontString(f, m, v);
                        d.textAlign = "left", d.textBaseline = "middle", d.lineWidth = .5, d.strokeStyle = p, d.fillStyle = p, d.font = g;
                        var b = l(i, f), y = t.legendHitBoxes, x = t.isHorizontal();
                        ...
                        a.each(t.legendItems, function (n, l) {
                            var p = d.measureText(n.text).width, m = b + f / 2 + p, v = u.x, g = u.y;
                            x ? v + m >= s && (g = u.y += w, u.line++, v = u.x = t.left + (s - c[u.line]) / 2) : g + w > t.bottom && (v = u.x = v + t.columnWidths[u.line] + i.padding, g = u.y = t.top + i.padding, u.line++), function (t, i, n) {
                                if (!(isNaN(b) || b <= 0)) {
                            ...
                            }(v, g, n), y[l].left = v, y[l].top = g, function (t, e, i, n) {
                                var o = f / 2, a = b + o + t, r = e + o;
                ...
                draw: function () {
                    ...
                    if (o.display) {
                        var s, l, c, u = i(o.fontSize, r.defaultFontSize), d = i(o.fontStyle, r.defaultFontStyle),
                            ...
                            f = a.options.toLineHeight(o.lineHeight, u), m = f / 2 + o.padding, v = 0, g = t.top,
                        ...
                        var w = o.text;
                        if (a.isArray(w)) for (var k = 0, C = 0; C < w.length; ++C) e.fillText(w[C], 0, k, s), k += f; else e.fillText(w, 0, 0, s);
                        e.restore()
                    }
                }
            });
            ...
            e.exports = function () {
                var t = n.extend({
                    getLabels: function () {
                        ...
                        if (n.isHorizontal()) {
                            var s = n.width / a, l = s * (e - n.minIndex);
                            return o && (l += s / 2), n.left + Math.round(l)
                        }
                        var c = n.height / a, u = c * (e - n.minIndex);
                ...
                var f = t.LinearScaleBase.extend({
                    setDimensions: function () {
                        ...
                        this.options.pointLabels.display ? function (t) {
                            var e, i, n, a = l(t), r = Math.min(t.height / 2, t.width / 2),
                            ...
                            for (e = 0; e < m; e++) {
                                ...
                                var v = t.getIndexAngle(e), g = o.toDegrees(v) % 360, b = c(g, n.x, i.w, 0, 180),
                        ...
                        if (i.display) {
                            var c = t.ctx, p = this.getIndexAngle(0), f = r(a.fontSize, e.defaultFontSize),
                                m = r(a.fontStyle, e.defaultFontStyle), v = r(a.fontFamily, e.defaultFontFamily),
                            ...
                            o.each(t.ticks, function (i, l) {
                                ...
                                for (var f = s(t) - 1; f >= 0; f--) {
                                    ...
                                    if (r.display) {
                                        ...
                                        var b = t.getIndexAngle(f), y = o.toDegrees(b);
            ...
            function b(t, e, i, o) {
                var r, s = o.time, l = s.unit || function (t, e, i, n) {
                        ...
                        return d[s - 1]
                    }(s.minUnit, t, e, i), h = g(l), p = a.valueOrDefault(s.stepSize, s.unitStepSize),
                    f = "week" === l && s.isoWeekday, m = o.ticks.major.enabled, v = u[l], b = n(t), y = n(e), x = [];
            ...
            e.exports = function () {
                var t = r.extend({
                    initialize: function () {
                        ...
                        var t, e, i, o, r, s, u = this, d = u.chart, f = u.options.time, m = f.unit || "day", g = c,
                            b = l, y = [], x = [], w = [];
                        for (t = 0, i = d.data.labels.length; t < i; ++t) w.push(v(d.data.labels[t], u));
                        for (t = 0, i = (d.data.datasets || []).length; t < i; ++t) if (d.isDatasetVisible(t)) if (r = d.data.datasets[t].data, a.isObject(r[0])) for (x[t] = [], e = 0, o = r.length; e < o; ++e) s = v(r[e], u), y.push(s), x[t][e] = s; else y.push.apply(y, w), x[t] = w.slice(0); else x[t] = [];
                        ...
                        var o = this.options, r = t.valueOf(), s = o.time.displayFormats, l = s[this._unit],
                            ...
                            m = p ? h : o.ticks.minor, v = a.valueOrDefault(m.callback, m.userCallback);
                        return v ? v(f, e, i) : f
    ...
    "use strict";
    var e = (t = t && t.hasOwnProperty("default") ? t.default : t).helpers, i = function () {
        ...
        toTextLines: function (t) {
            ...
            var n, o = [].concat(e), a = o.length, r = t.font, s = 0;
            for (t.font = i.string, n = 0; n < a; ++n) s = Math.max(t.measureText(o[n]).width, s);
            return t.font = r, {height: a * i.lineHeight, width: s}
        }, parseFont: function (i) {
            var o = t.defaults.global, a = e.valueOrDefault(i.size, o.defaultFontSize), r = {
    ...
    function o(t, e) {
        ...
        var o = t.x - i, a = t.y - n, r = Math.sqrt(o * o + a * a);
        return {x: r ? o / r : 0, y: r ? a / r : -1}
    }

    var a = 0, r = 1, s = 2, l = 4, c = 8;
    ...
    function d(t, e) {
        ...
        return e.clamp && (a = function (t, e) {
            ...
            return {x0: a, x1: h, y0: d, y1: p}
        }(a, e.area)), "start" === o ? (i = a.x0, n = a.y0) : "end" === o ? (i = a.x1, n = a.y1) : (i = (a.x0 + a.x1) / 2, n = (a.y0 + a.y1) / 2), function (t, e, i, n, o) {
            switch (o) {
                case"center":
                    i = n = 0;
                    break;
            ...
            return {x: t, y: e, vx: i, vy: n}
        }(i, n, t.vx, t.vy, e.align)
    }

    var h = {
        arc: function (t, e) {
            var i = (t.startAngle + t.endAngle) / 2, n = Math.cos(i), o = Math.sin(i), a = t.innerRadius,
                r = t.outerRadius;
            return d({x0: t.x + n * a, y0: t.y + o * a, x1: t.x + n * r, y1: t.y + o * r, vx: n, vy: o}, e)
        }, point: function (t, e) {
            var i = o(t, e.origin), n = i.x * t.radius, a = i.y * t.radius;
            return d({x0: t.x - n, y0: t.y - a, x1: t.x + n, y1: t.y + a, vx: i.x, vy: i.y}, e)
        }, rect: function (t, e) {
            var i = o(t, e.origin), n = t.x, a = t.y, r = 0, s = 0;
            ...
            var i = o(t, e.origin);
            return d({x0: t.x, y0: t.y, x1: t.x, y1: t.y, vx: i.x, vy: i.y}, e)
        }
    }, p = t.helpers, f = n.rasterize;

    function m(t) {
        var e = t._model.horizontal, i = t._scale || e && t._xScale || t._yScale;
        if (!i) return null;
    ...
    function v(t, e, i) {
        var n = t.shadowBlur, o = i.stroked, a = f(i.x), r = f(i.y), s = f(i.w);
    ...
    p.extend(g.prototype, {
        _modelize: function (e, i, o, a) {
            var r, s = this._index, l = p.options.resolve, c = n.parseFont(l([o.font, {}], a, s)),
            ...
            var e, i, o, a = this, r = null, s = null, l = a._index, c = a._config,
            ...
            u && (e = t.dataset.data[l], i = p.valueOrDefault(p.callback(c.formatter, [e, t]), e), (o = p.isNullOrUndef(i) ? [] : n.toTextLines(i)).length && (s = function (t) {
                var e = t.borderWidth || 0, i = t.padding, n = t.size.height, o = t.size.width, a = -o / 2, r = -n / 2;
                return {
                    frame: {x: a - i.left - e, y: r - i.top - e, w: o + i.width + 2 * e, h: n + i.height + 2 * e},
                    text: {x: a, y: r, w: o, h: n}
                }
            ...
            var i, o = t.ctx, a = this._model, r = this._rects;
            this.visible() && (o.save(), a.clip && (i = a.area, o.beginPath(), o.rect(i.left, i.top, i.right - i.left, i.bottom - i.top), o.clip()), o.globalAlpha = n.bound(0, a.opacity, 1), o.translate(f(e.x), f(e.y)), o.rotate(a.rotation), function (t, e, i) {
                var n = i.backgroundColor, o = i.borderColor, a = i.borderWidth;
                ...
                var o, a = n.textAlign, r = n.color, s = !!r, l = n.font, c = e.length, u = n.textStrokeColor,
                    d = n.textStrokeWidth, h = u && d;
                if (c && (s || h)) for (i = function (t, e, i) {
                    var n = i.lineHeight, o = t.w, a = t.x;
    ...
    var b = t.helpers, y = Number.MIN_SAFE_INTEGER || -9007199254740991,
        x = Number.MAX_SAFE_INTEGER || 9007199254740991;

    function w(t, e, i) {
        var n = Math.cos(i), o = Math.sin(i), a = e.x, r = e.y;
        return {x: a + n * (t.x - a) - o * (t.y - r), y: r + o * (t.x - a) + n * (t.y - r)}
    }

    function k(t, e) {
        var i, n, o, a, r, s = x, l = y, c = e.origin;
    ...
    function M(t, e, i) {
        var n = e.positioner(t, e), o = n.vx, a = n.vy;
        if (!o && !a) return {x: n.x, y: n.y};
        var r = i.w, s = i.h, l = e.rotation, c = Math.abs(r / 2 * Math.cos(l)) + Math.abs(s / 2 * Math.sin(l)),
            u = Math.abs(r / 2 * Math.sin(l)) + Math.abs(s / 2 * Math.cos(l)),
            d = 1 / Math.max(Math.abs(o), Math.abs(a));
        return c *= o * d, u *= a * d, c += e.offset * o, u += e.offset * a, {x: n.x + c, y: n.y + u}
    }
    ...
    b.extend(S.prototype, {
        center: function () {
            ...
            var e, i, n, o = this._points(), a = t._points(), r = [C(o[0], o[1]), C(o[0], o[3])];
            for (this._rotation !== t._rotation && r.push(C(a[0], a[1]), C(a[0], a[3])), e = 0; e < r.length; ++e) if (i = k(o, r[e]), n = k(a, r[e]), i.max < n.min || n.max < i.min) return !1;
            return !0
        }, _points: function () {
            var t = this._rect, e = this._rotation, i = this.center();
            return [w({x: t.x, y: t.y}, i, e), w({x: t.x + t.w, y: t.y}, i, e), w({
                x: t.x + t.w,
                y: t.y + t.h
            }, i, e), w({x: t.x, y: t.y + t.h}, i, e)]
        }
    });
    var T = {
        prepare: function (t) {
            var e, i, n, o, a, r = [];
            for (e = 0, n = t.length; e < n; ++e) for (i = 0, o = t[e].length; i < o; ++i) a = t[e][i], r.push(a), a.$layout = {
                _box: new S,
                _hidable: !1,
                _visible: !0,
                _set: e,
            ...
            r && function (t) {
                ...
                (function (t, e) {
                    var i, n, o, a;
                    for (i = t.length - 1; i >= 0; --i) for (o = t[i].$layout, n = i - 1; n >= 0 && o._visible; --n) (a = t[n].$layout)._visible && o._box.intersects(a._box) && e(o, a)
                })(t, function (t, e) {
                    var i = t._hidable, n = e._hidable;
                    i && n || n ? e._visible = !1 : i && (t._visible = !1)
                })
            }(t)
        }, lookup: function (t, e) {
            var i, n;
            for (i = t.length - 1; i >= 0; --i) if ((n = t[i].$layout) && n._visible && n._box.contains(e)) return t[i];
            return null
        }, draw: function (t, e) {
            var i, n, o, a, r, s;
        ...
        formatter: function (t) {
            ...
            var e, i, n, o = t;
            if (O.isObject(t)) if (O.isNullOrUndef(t.label)) if (O.isNullOrUndef(t.r)) for (o = "", n = 0, i = (e = Object.keys(t)).length; n < i; ++n) o += (0 !== n ? ", " : "") + e[n] + ": " + t[e[n]]; else o = t.r; else o = t.label;
            return "" + o
        },
        labels: void 0,
        listeners: {},
    ...
    }, P = t.helpers, A = "$datalabels", I = "$default";

    function $(t, e, i) {
        if (e) {
            var n, o = i.$context, a = i.$groups;
            e[a._set] && (n = e[a._set][a._key]) && !0 === P.callback(n, [o]) && (t[A]._dirty = !0, i.update(o))
        }
    }

    function D(t, e) {
        var i, n, o = t[A], a = o._listeners;
        if (a.enter || a.leave) {
            if ("mousemove" === e.type) n = T.lookup(o._labels, e); else if ("mouseout" !== e.type) return;
            i = o._hovered, o._hovered = n, function (t, e, i, n) {
                var o, a;
    ...
    var E = {
        id: "datalabels", beforeInit: function (t) {
            t[A] = {_actives: []}
        }, beforeUpdate: function (t) {
            var e = t[A];
            e._listened = !1, e._listeners = {}, e._datasets = [], e._labels = []
        }, afterDatasetUpdate: function (t, e, i) {
            var n, o, a, r, s, l, c, u, d = e.index, h = t[A], p = h._datasets[d] = [], f = t.isDatasetVisible(d),
                m = t.data.datasets[d], v = function (t, e) {
                    var i, n, o, a = t.datalabels, r = [];
                    return !1 === a ? null : (!0 === a && (a = {}), e = P.merge({}, [e, a]), n = e.labels || {}, o = Object.keys(n), delete e.labels, o.length ? o.forEach(function (t) {
                        n[t] && r.push(P.merge({}, [e, n[t], {_key: t}]))
                    }) : r.push(e), i = r.reduce(function (t, e) {
                        return P.each(e.listeners || {}, function (i, n) {
                            t[n] = t[n] || {}, t[n][e._key || I] = i
                        }), delete e.listeners, t
                    }, {}), {labels: r, listeners: i})
                }(m, i), b = e.meta.data || [], y = t.ctx;
            for (y.save(), n = 0, a = b.length; n < a; ++n) if ((c = b[n])[A] = [], f && c && !c.hidden && !c._model.skip) for (o = 0, r = v.labels.length; o < r; ++o) l = (s = v.labels[o])._key, (u = new g(s, y, c, n)).$groups = {
                _set: d,
                _key: l || I
            }, u.$context = {
                active: !1,
            ...
            if (t[A]._listened) switch (e.type) {
                ...
                case"click":
                    !function (t, e) {
                        var i = t[A], n = i._listeners.click, o = n && T.lookup(i._labels, e);
                        o && $(t, n, o)
                    }(t, e)
            }
        }, afterEvent: function (e) {
            var i, o, a, r, s, l, c, u = e[A], d = u._actives, h = u._actives = e.lastActive || [],
                p = n.arrayDiff(d, h);
            for (i = 0, o = p.length; i < o; ++i) if ((s = p[i])[1]) for (a = 0, r = (c = s[0][A] || []).length; a < r; ++a) (l = c[a]).$context.active = 1 === s[1], l.update(l.$context);
            (u._dirty || p.length) && (T.update(u._labels), function (e) {
                if (!e.animating) {
                    for (var i = t.animationService.animations, n = 0, o = i.length; n < o; ++n) if (i[n].chart === e) return;
    ...
    var e = function () {
        ...
        return i.init = function () {
            ...
            var i = this.getOffset(this.$wowElement[0]), n = this.$wowElement.height(), o = t(document).height(),
                a = window.innerHeight, r = window.scrollY, s = a + r - this.options.offset > i,
                l = a + r - this.options.offset > i + n, c = r < i, u = r < i + n, d = a + r === o,
                h = i + this.options.offset > o, p = a + r - this.options.offset < i, f = r > i + this.options.offset,
                m = r < i + this.options.offset, v = i + n > o - this.options.offset;
            return e ? s && c || l && u || d && h : s && f || p && m || v
        }, i.countRemoveTime = function () {
            var t = 1e3 * this.$wowElement.css("animation-duration").slice(0, -1), e = 0;
            ...
            var e;
            if ("s" === t.toString().slice(-1)) e = t.toString().slice(0, -1); else {
    ...
    (new (function () {
        ...
        return i.init = function () {
            ...
            t(this.inputSelector).each(function (e, n) {
                var o = t(n), a = n.validity.badInput;
            ...
            this.$document.on("blur", this.inputSelector, function (i) {
                var n = t(i.target), o = !n.val(), a = !i.target.validity.badInput,
            ...
            this.$document.on("reset", function (i) {
                ...
                n.is("form") && (n.find(e.inputSelector).removeClass("valid invalid").each(function (i, n) {
                    var o = t(n), a = !o.val(), r = !o.attr("placeholder");
            ...
            var e = Boolean(t.val().length), i = Boolean(t.attr("placeholder")), n = e || i ? "add" : "remove";
            ...
            if (t.hasClass("validate")) {
                ...
                if (i && n) t.removeClass("valid").removeClass("invalid"); else {
                    var o = t[0].validity.valid, a = Number(t.attr("length")) || 0;
...
var loader_path = "./dev/dist/mdb-addons/preloader.html", windowLoaded = !1;
...
$(window).on("load", function () {
    ...
    t(document).on("click.card", ".card", function (n) {
        ...
        if (o.length) {
            var a = t(n.target), r = a.is(".card-reveal .card-title"), s = a.is(".card-reveal .card-title i"),
                l = a.is(".card .activator"), c = a.is(".card .activator i");
            r || s ? i(o) : (l || c) && e(o)
        }
    });
    var e = function (t) {
        t.css({display: "block"}).velocity({translateY: "-100%"}, {duration: 300, queue: !1, easing: "easeInOutQuad"})
    }, i = function (t) {
        t.velocity({translateY: 0}, {
    ...
    t(".rotate-btn").on("click", function () {
        ...
        t(".card-rotating").each(function () {
            var e = t(this), i = e.parent(), n = e.find(".front"), o = e.find(".back"),
                a = e.find(".front").outerHeight(), r = e.find(".back").outerHeight();
    ...
    function e() {
        var e = t(this), i = Number(e.attr("length")), n = Number(e.val().length), o = n <= i;
        e.parent().find('span[class="character-counter"]').html(n + "/" + i), function (t, e) {
            ...
            function u(i) {
                ...
                if (void 0 !== i.optionsOverride && (a = t.extend(a, i.optionsOverride), r = i.optionsOverride.iconClass || r), !function (t, e) {
                    ...
                    var l = null, u = t("<div/>"), p = t("<div/>"), f = t("<div/>"), m = t("<div/>"),
                        v = t(a.closeHtml), g = {intervalId: null, hideEta: null, maxHideTime: null},
                    ...
                    return i.iconClass && u.addClass(a.toastClass).addClass(r), i.title && (p.append(i.title).addClass(a.titleClass), u.append(p)), i.message && (f.append(i.message).addClass(a.messageClass), u.append(f)), a.closeButton && (v.addClass("md-toast-close-button").attr("role", "button"), u.prepend(v)), a.progressBar && (m.addClass("md-toast-progress"), u.prepend(m)), a.newestOnTop ? e.prepend(u) : e.append(u), u.hide(), u[a.showMethod]({
                        ...
                        easing: a.showEasing,
                        complete: a.onShown
                    }), a.timeOut > 0 && (l = setTimeout(y, a.timeOut), g.maxHideTime = parseFloat(a.timeOut), g.hideEta = (new Date).getTime() + g.maxHideTime, a.progressBar && (g.intervalId = setInterval(k, 10))), function () {
    ...
    $(".smooth-scroll").on("click", "a", function (t) {
        ...
        if (void 0 !== typeof i && 0 === i.indexOf("#")) {
            ...
            $("body,html").animate({scrollTop: $(i).offset().top - n}, 700);
    ...
    var e = "ontouchstart" in document.documentElement, i = function (t, e) {
    ...
    var e = function () {
        ...
        return i.assignOptions = function (e) {
            ...
            var e = this;
            "left" === this.options.edge ? (this.$menu.css("transform", "translateX(-100%)"), this.$dragTarget.css({left: 0})) : (this.$menu.addClass("right-aligned").css("transform", "translateX(100%)"), this.$dragTarget.css({right: 0})), this.$menu.hasClass("fixed") && (window.innerWidth > this.options.breakpoint ? (this.menuOut = !0, this.$menu.css("transform", "translateX(0)")) : this.menuOut = !1, this.$menu.find("input[type=text]").on("touchstart", function () {
                e.$menu.addClass("transform-fix-input")
            }), t(window).on("resize", function () {
                if (t(".fixed-sn main, .fixed-sn footer").css("padding-left", e.options.menuWidth), window.innerWidth > e.options.breakpoint) e.$sidenavOverlay.length ? (e.removeMenu(!0), t(".fixed-sn main, .fixed-sn footer").css("padding-left", e.options.menuWidth)) : (!1 === e.menuOut && t(e).trigger("sidenav_open", [e.options.onOpen]), e.$menu.css("transform", "translateX(0%)"), e.menuOut = !0); else if (!1 === e.menuOut) {
            ...
            this.$element.on("click", function (i) {
                ...
                var n = [];
                n = "left" === e.options.edge ? [0, -1 * e.options.menuWidth] : [0, e.options.menuWidth], "matrix(1, 0, 0, 1, 0, 0)" !== e.$menu.css("transform") && e.$menu.velocity({translateX: n}, {
            ...
            }), this.$menu.removeClass("transform-fix-input"), this.hideSidenavOverlay(), this.menuOut = !1, t(".fixed-sn .double-nav").css("padding-left", "unset"), t(".fixed-sn main, .fixed-sn footer").css({"padding-left": "0"}), t(this).trigger("sidenav_close", [this.options.onClose])
            ...
            t("#toggle").on("click", function () {
                e.$menu.hasClass("slim") ? (e.$menu.removeClass("slim"), t(".sv-slim-icon").removeClass("fa-angle-double-right").addClass("fa-angle-double-left"), t(".fixed-sn .double-nav").css({
                    ...
                    transition: "all .3s ease-in-out",
                    "padding-left": "15rem"
                })) : (e.$menu.addClass("slim"), t(".sv-slim-icon").removeClass("fa-angle-double-left").addClass("fa-angle-double-right"), t(".fixed-sn .double-nav").css("padding-left", "4.6rem"), t(".fixed-sn main, .fixed-sn footer").css({"padding-left": "3.7rem"}))
            })
        }, i.touchmoveEventHandler = function (t) {
            if ("touchmove" === t.type) {
                var e = t.touches[0], i = e.clientX;
            ...
            if ("touchend" === t.type) {
                ...
                var i = this.calculateTouchVelocityX(), n = e.clientX, o = n - this.options.menuWidth,
            ...
            var e;
            e = "left" === this.options.edge ? t / this.options.menuWidth : Math.abs((t - window.innerWidth) / this.options.menuWidth), this.$sidenavOverlay.velocity({opacity: e}, {
                duration: 10,
                queue: !1,
                easing: this.options.easingOpen
            })
        }, i.showSidenavOverlay = function () {
            !0 !== this.options.showOverlay || t("#sidenav-overlay").length || this.buildSidenavOverlay(), this.$sidenavOverlay.velocity({opacity: 1}, {
    ...
    t.fn.collapsible = function (a) {
        var r = {accordion: void 0};
        return a = t.extend(r, a), this.each(function () {
            var r = t(this), s = r.find("> li > .collapsible-header"), l = r.data("collapsible");
    ...
    var e = "input[type=range]:not(.custom-range):not(.multi-range)",
        i = '<span class="thumb" style="margin-left: 7px"><span class="value"></span></span>', n = !1;

    function o(t, e) {
        var i = t.attr("min"), n = t.attr("max"), o = t.width() - 13.5, a = o / (n - i), r = a * t.val() - a * i;
        r < 0 ? r = 0 : r > o && (r = o), e.addClass("active").css("left", r)
    }

    function a(t, e, i, n, o, a, r) {
        t.velocity({height: e, width: i, top: n, marginLeft: o}, {duration: a, easing: r || "swing"})
    }
    ...
    t(document).on("change", e, function () {
        ...
        var s = t(this), l = !s.siblings(".thumb").length, c = "contextmenu" === a.type;
        l && function () {
            var n = t(i);
            t(e).after(n)
        }();
    ...
    t(document).on("change", '.file-field input[type="file"]', function () {
        var e = t(this);
        console.log(e);
        var i = e.closest(".file-field").find("input.file-path"), n = e.get(0).files, o = [];
    ...
    var e = function () {
        ...
        e.mdbDropdownAutoInit = function () {
            ...
            t(".dropdown, .dropup").on({
                "show.bs.dropdown": function (i) {
                    var n = t(i.target), o = e._getDropdownEffects(n);
                    ...
                    var n = window.matchMedia("(prefers-reduced-motion: reduce)").matches, o = t(i.target),
            ...
            var e = "fadeIn", i = "fadeOut", n = t.find(".dropdown-menu"), o = t.parents("ul.nav");
        ...
        return i.returnPublicInterface = function () {
            ...
            this.$activator.unbind("click." + this.$activator.attr("id")), this.$activator.bind("click." + this.$activator.attr("id"), function (i) {
                if (!e.isFocused) {
                    var n = e.$activator.get(0) === i.currentTarget, o = e.$activator.hasClass("active"),
            ...
            }).animate(_objectSpread({opacity: 1}, this.options.resetScroll && {scrollTop: 0}), {
                queue: !1,
                duration: this.options.inDuration,
                easing: "easeOutSine"
            })
            ...
            var e = window.innerHeight, i = this.$activator.innerHeight(),
                n = this.$activator.offset().top - t(window).scrollTop(), o = this._getHorizontalAlignment(), a = 0,
                r = 0, s = this.$activator.parent(), l = this.options.belowOrigin ? i : 0,
                c = !s.is("body") && s.get(0).scrollHeight > s.get(0).clientHeight ? s.get(0).scrollTop : 0,
                u = n + this.$activates.innerHeight() > e, d = n + i - this.$activates.innerHeight() < 0;
            if (u && d) {
                var h = e - n - l;
                this.$activates.css("max-height", h)
            } else u && (l || (l += i), l -= this.$activates.innerHeight());
            if ("left" === o) a = this.options.gutter, r = this.$activator.position().left + a; else if ("right" === o) {
                r = this.$activator.position().left + this.$activator.outerWidth() - this.$activates.outerWidth() + (a = -this.options.gutter)
            }
            this.$activates.css({position: "absolute", top: this.$activator.position().top + l + c, left: r})
            ...
            this.$searchWrappers.each(function () {
                ...
                e.on("keyup", function () {
                    e.closest("div[id]").find("a, li").each(function () {
                        var i = t(this);
                        i.html().toLowerCase().indexOf(e.val().toLowerCase()) > -1 ? i.css({display: ""}) : i.css({display: "none"})
                    })
                })
            })
        }, i.fallback = function () {
...
var MaterialSelectViewRenderer = function () {
    ...
    return e.destroy = function () {
        ...
        if (this.view.options.placeholder) this.view.$materialSelect.attr("placeholder", this.view.options.placeholder), this.view.$nativeSelect.find('option[value=""][selected][disabled][data-mdb-placeholder]').length || this.view.$nativeSelect.prepend('<option value="" selected disabled data-mdb-placeholder></option>'); else {
        ...
        var e = this.view.$materialOptionsList.clone().appendTo(t), i = this.view.options.visibleOptions, n = 0,
            o = e.find("li").not(".disabled"),
            a = "" === o.first().text().trim() ? o.eq(1).height() : o.first().height(), r = o.length;
        ...
        var t = this.view.$nativeSelect.attr("searchable"), e = this.isDefaultMaterialInput ? "" : "md-form",
        ...
        this.view.$nativeSelectChildren.each(function (e, i) {
            var n = $(i);
            if (n.is("option")) t.buildSingleOption(n, t.isMultiple ? "multiple" : ""); else if (n.is("optgroup")) {
        ...
        var i = t.is(":disabled") ? "disabled" : "", n = t.is(":selected") ? "active" : "",
            o = "optgroup-option" === e ? "optgroup-option" : "", a = t.data("icon"),
            ...
            c = t.attr("class"), u = a ? '<img alt="" src="' + a + '" class="' + c + '">' : "",
        ...
        key: "shouldValidate", get: function () {
            return this.view.options.validate
        }
    }, {
        key: "shouldInheritTabindex", get: function () {
        ...
        key: "isSearchable", get: function () {
            return this.view.isSearchable
        }
    }, {
        key: "isRequired", get: function () {
        ...
        key: "isDefaultMaterialInput", get: function () {
            return this.view.options.defaultMaterialInput
        }
    }, {
        key: "isCustomSelect", get: function () {
...
var MaterialSelectView = function () {
    function t(t, e) {
        var i = e.options, n = e.properties.id;
        this.properties = {
            id: n,
    ...
    return e.destroy = function () {
        ...
        this.$materialSelect.on("focus", function (e) {
            ...
            if (i.parent().addClass("active"), $("ul.select-dropdown").not(t.$materialOptionsList.get(0)).is(":visible") && $("input.select-dropdown").trigger("close"), t.$mainLabel.addClass("active"), !t.$materialOptionsList.is(":visible")) {
                var n = i.val(), o = t.$materialOptionsList.find("li").filter(function () {
        ...
        this.$materialSelect.on("keydown", function (e) {
            var i = $(e.target), n = e.which === t.keyCodes.tab, o = e.which === t.keyCodes.arrowUp,
                a = e.which === t.keyCodes.arrowDown, r = e.which === t.keyCodes.enter, s = e.which === t.keyCodes.esc,
                l = a && e.altKey, c = o && e.altKey, u = e.which === t.keyCodes.home, d = e.which === t.keyCodes.end,
                h = e.which === t.keyCodes.space, p = t.$materialOptionsList.is(":visible");
            switch (!0) {
                case n:
        ...
        this.$toggleAll.on("click", function (i) {
            var n = $(e.$toggleAll).find('input[type="checkbox"]').first(), o = Boolean($(n).prop("checked")), a = !o;
            $(n).prop("checked", !o), e.$materialOptionsList.find("li:not(.optgroup):not(.select-toggle-all)").each(function (i, n) {
                var o = $(n), r = o.find('input[type="checkbox"]');
        ...
        this.$searchInput.find(".search").on("keyup", function (e) {
            var i = $(e.target), n = e.which === t.keyCodes.tab, o = e.which === t.keyCodes.esc,
                a = e.which === t.keyCodes.enter, r = a && e.shiftKey, s = e.which === t.keyCodes.arrowUp;
            if (e.which === t.keyCodes.arrowDown || n || o || s) return t.$materialSelect.focus(), void t._handleArrowUpDownKey(e.which);
            var l = i.closest("ul"), c = i.val(), u = l.find("li span.filtrable"), d = !1;
            if (u.each(function () {
                var t = $(this);
        ...
        var e = this._getArrowMatchedActiveOptions(t, !1), i = e.$matchedMaterialOption, n = e.$activeOption;
        ...
        var i = this, n = e ? "" : ":visible",
            o = this.$materialOptionsList.find("li" + n).not(".disabled, .select-toggle-all"), a = o.first(),
            r = o.last(), s = this.$materialOptionsList.find("li.selected").length > 0, l = null, c = null;
        ...
        if (this._removeKeyboardActiveClass(), this.isSearchable) {
            var i = t.which > 46 && t.which < 91, n = t.which > 93 && t.which < 106, o = 8 === t.which;
            (i || n) && this.$searchInput.find("input").focus(), o && this.$searchInput.find("input").val("").focus()
        } else {
            var a = "", r = String.fromCharCode(t.which).toLowerCase(),
        ...
        for (var t = null, e = 0; e < arguments.length; e++) if ((t = e < 0 || arguments.length <= e ? void 0 : arguments[e]).length) return t;
        return t
    }, _createClass(t, [{
        key: "isMultiple", get: function () {
        ...
        key: "isMobileDevice", get: function () {
...
jQuery(function (t) {
    var e, i = function () {
        ...
        return i.init = function () {
            ...
            e.forEach(function (e) {
                ...
                !0 !== i.data("stop-refresh") && ("childList" === e.type || "attributes" === e.type && t(e.target).is("option")) && (i.materialSelect({destroy: !0}), i.materialSelect())
            })
            ...
            var e = this.selectedOptionsIndexes.indexOf(t), i = -1 !== e;
            ...
            var t = this, e = "", i = this.selectedOptionsIndexes.length;
    ...
    function a(e, n, c, d) {
        if (!e) return a;
        var h = !1, p = {id: e.id || "P" + Math.abs(~~(Math.random() * new Date)), handlingOpen: !1},
            f = c ? t.extend(!0, {}, c.defaults, d) : d || {}, m = t.extend({}, a.klasses(), f.klass), v = t(e), g = 2,
            b = function () {
                return this.start()
            }, y = b.prototype = {
                constructor: b, $node: v, start: function () {
                    ...
                    return g++, p.open ? y : g < 4 && f.editable ? y : (setTimeout(function () {
                        ...
                        var n = i.keyCode, o = y.component.key[n], r = s(i, e);
        ...
        function w() {
            y.$holder.on({
                keydown: C, "focus.toOpen": k, blur: function () {
                ...
                var e = t(this), i = e.data(), n = e.hasClass(m.navDisabled) || e.hasClass(m.disabled), o = u();
    ...
    function l(e, i, n) {
        if (t.isPlainObject(i)) for (var o in i) c(e, o, i[o]); else c(e, i, n)
    }
    ...
    o.prototype.set = function (t, e, i) {
        ...
        return n.isInteger(e) ? e = this.now(t, e, {rel: e}) : e ? "string" == typeof e && (e = this.parse(t, e)) : e = "min" == t ? -1 / 0 : 1 / 0, e
    ...
    selectMonths: !0, selectYears: 15, onRender: function () {
        var t = this.$root, e = this.get("highlight", "yyyy"), i = this.get("highlight", "dd"),
            n = this.get("highlight", "mmm"), o = this.get("highlight", "dddd").slice(0, 3),
    ...
    var g = 0;
    var b = 135, y = 110, x = 80, w = 20, k = 2 * b, C = l ? 350 : 1,
    ...
    function M(t, e) {
        var i, o, r = n(S), l = r.find(".clockpicker-plate"), c = r.find(".picker__holder"),
            p = r.find(".clockpicker-hours"), M = r.find(".clockpicker-minutes"),
            O = r.find(".clockpicker-am-pm-block"), _ = "INPUT" === t.prop("tagName"), P = _ ? t : t.find("input"),
            A = (P.prop("type"), n("label[for=" + P.attr("id") + "]")), I = this;
        ...
        const $ = t => {
            ...
            if (2 !== this[i].length) this[i] = null; else for (let t = 0; t < this[i].length; t++) this[i][t] = +this[i][t]
        };
        ...
        if (e.twelvehour) for (E = 0; E < 12; E += e.hourstep) L = W.clone(), F = E / 6 * Math.PI, R = y, L.css("font-size", "140%"), L.css({
            left: b + Math.sin(F) * R - w,
            top: b - Math.cos(F) * R - w
        }), L.html(0 === E ? 12 : E), p.append(L), L.on(u, z), this.disableOutOfRangeElements(); else for (E = 0; E < 24; E += e.hourstep) {
        ...
        for (E = 0; E < 60; E += H) for (E = 0; E < 60; E += 5) L = W.clone(), F = E / 30 * Math.PI, L.css({
            left: b + Math.sin(F) * y - w,
            top: b - Math.cos(F) * y - w
        }), L.css("font-size", "140%"), L.html(v(E)), M.append(L), L.on(u, z);

        function z(t, i) {
            var n = l.offset(), o = /^touch/.test(t.type), r = n.left + b, c = n.top + b,
            ...
            if (!i || !(f < y - w || f > y + w)) {
                ...
                s && l.append(I.canvas), I.setHand(u, p, !i, !0), a.off(d).on(d, function (t) {
                    ...
                    let {hours: f, minutes: g, amOrPm: b, maxHours: y, minHours: x, maxMinutes: w, minMinutes: k} = I;
        ...
        if (l.on(u, function (t) {
            ...
            var N = r.find(".clockpicker-canvas"), B = f("svg");
    ...
    M.DEFAULTS = {
        ...
        let {hours: t, minutes: e, currentView: i, isTwelvehour: o, amOrPm: a, maxHours: r, minHours: s, maxMinutes: l, minMinutes: c} = this;
        const u = n(".clockpicker-hours").children(), d = n(".clockpicker-minutes").children(), h = n(".am-button"),
            p = n(".pm-button"), f = n(".done-button");
        ...
        var e = this.currentView, i = this[e], n = "hours" === e, o = i * (Math.PI / (n ? 6 : 30)),
            a = n && i > 0 && i < 13 ? x : y, r = Math.sin(o) * a, l = -Math.cos(o) * a, c = this;
        ...
        var a, r, l = Math.atan2(t, -e), c = "hours" === this.currentView, u = Math.sqrt(t * t + e * e),
            d = this.options, h = c && u < (y + x) / 2, f = h ? x : y;
        ...
        let {minHours: m, maxHours: g, minMinutes: b, maxMinutes: w, amOrPm: k} = this;
        if (c) {
            let t = r;
        ...
        if (c ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : r % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"), this[this.currentView] !== r && p && this.options.vibrate && (this.vibrateTimer || (navigator[p](10), this.vibrateTimer = setTimeout(n.proxy(function () {
            ...
            var C = Math.sin(l) * f, S = -Math.cos(l) * f;
        ...
        var t = this.input.prop("value"), e = this.hours, i = ":" + v(this.minutes);
    ...
    t.fn.dateTimePicker = function (e = ", ") {
        ...
        const o = t(`.timepicker[data-open='${i.dataset.open}']`), a = t(`#${i.dataset.open}`);
        a.pickadate({
            onClose: function () {
                o.pickatime({
                    afterHide: () => {
    ...
    return function (t, e, i, n) {
        ...
        o.extend(r, n);
        var s, l, c, u, d, h, p, f, m, v, g, b, y, x, w, k, C, S, M, T, O, _, P, A, I, $, D, E, L, F, R, W, V, H, z, N,
            B, j, Y, q, X, U, K, Q, Z, G, J, tt, et, it, nt, ot, at, rt, st, lt = {x: 0, y: 0}, ct = {x: 0, y: 0},
            ut = {x: 0, y: 0}, dt = {}, ht = 0, pt = {}, ft = {x: 0, y: 0}, mt = 0, vt = !0, gt = [], bt = {}, yt = !1,
            xt = function (t, e) {
                ...
                shout: St, listen: Ct, viewportSize: dt, options: r, isMainScrollAnimating: function () {
                    return et
                    ...
                    if (!s && !l) {
                        ...
                        }(), m = {resize: a.updateSize, scroll: Bt, keydown: zt, click: Nt};
            ...
            }, Zt = {}, Gt = {}, Jt = {}, te = {}, ee = {}, ie = [], ne = {}, oe = [], ae = {}, re = 0, se = {x: 0, y: 0},
            le = 0, ce = {x: 0, y: 0}, ue = {x: 0, y: 0}, de = {x: 0, y: 0}, he = function (t, e) {
                ...
                if (j) {
                    var n = Se(t);
                    if (it || X || Z) Q = n; else if (ce.x !== ft.x * ht) it = "h"; else {
                ...
                var c = -1;
                if (0 === l && (j = !1, o.unbind(window, p, a), pe(), Z ? c = 0 : -1 !== le && (c = Mt() - le)), le = 1 === l ? Mt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", Z && 2 > l && (Z = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Q = null, X || q || et || N) if (Ut(), H || (H = Ae()), H.calculateSwipeSpeed("x"), N) if (xe() < r.verticalDragRange) a.close(); else {
                    var u = ut.y, d = at;
            ...
            !function () {
                ...
                e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (v = l.w / e.w, ut.x = l.x, ut.y = l.y - E, a[s ? "template" : "bg"].style.opacity = .001, _t()), Xt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
                    ...
                    if (St("initialZoom" + (n ? "Out" : "In")), n) {
                        var a = l.w / e.w, r = {x: ut.x, y: ut.y}, c = v, u = at, p = function (e) {
            ...
            publicMethods: {
                lazyLoadItem: function (t) {
                    ...
                    o.extend(r, je, !0), a.items = Fe = i, Ve = a.getItemAt, He = r.getNumItemsFn, r.loop, He() < 3 && (r.loop = !1), Ct("beforeChange", function (t) {
                        var e, i = r.preload, n = null === t || t >= 0, o = Math.min(i[0], He()),
                            s = Math.min(i[1], He());
                    ...
                    if (l) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Ke(l, n), qe(0, l, c, n)); else {
        ...
        xt("Tap", {
            ...
            publicMethods: {
                initDesktopZoom: function () {
                    ...
                    var i = r.getDoubleTapZoom(!0, a.currItem), n = v === i;
        ...
        var ei, ii, ni, oi, ai, ri, si, li, ci, ui, di, hi, pi = {history: !0, galleryUID: 1}, fi = function () {
            ...
            if (ni && clearTimeout(ni), Yt || j) ni = setTimeout(gi, 500); else {
    ...
    "use strict";
    return function (t, e) {
        var i, n, o, a, r, s, l, c, u, d, h, p, f, m, v, g, b, y, x = this, w = !1, k = !0, C = !0, S = {
            ...
            if (T()) {
                var r = v.barsSize;
                if (v.captionEl && "auto" === r.bottom) if (a || ((a = e.createEl("pswp__caption pswp__caption--fake")).appendChild(e.createEl("pswp__caption__center")), n.insertBefore(a, o), e.addClass(n, "pswp__ui--fit")), v.addCaptionHTMLFn(t, a, !0)) {
        ...
        x.init = function () {
            e.extend(t.options, S, !0), v = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen, function () {
                var t;
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (t, e) {
    ...
    function c(t, e) {
        var i = t.element.classList, n = s.state.scrolling(e);
    ...
    function m(t, e, i, n, o) {
        var a;
        if (void 0 === n && (n = !0), void 0 === o && (o = !1), "top" === e) a = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"]; else {
            if ("left" !== e) throw new Error("A proper axis should be provided");
            a = ["contentWidth", "containerWidth", "scrollLeft", "x", "left", "right"]
        }
        !function (t, e, i, n, o) {
            var a = i[0], r = i[1], s = i[2], l = i[3], d = i[4], h = i[5];
            void 0 === n && (n = !0);
            void 0 === o && (o = !1);
            var p = t.element;
    ...
    function b(t) {
        var i = t.element, n = Math.floor(i.scrollTop), o = i.getBoundingClientRect();
        t.containerWidth = Math.ceil(o.width), t.containerHeight = Math.ceil(o.height), t.contentWidth = i.scrollWidth, t.contentHeight = i.scrollHeight, i.contains(t.scrollbarXRail) || (r(i, s.element.rail("x")).forEach(function (t) {
            ...
            var n = {width: i.railXWidth}, o = Math.floor(t.scrollTop);
    ...
    function x(t, e) {
        var i = e[0], n = e[1], o = e[2], a = e[3], r = e[4], l = e[5], d = e[6], h = e[7], p = e[8], f = t.element,
    ...
    var w = {
        "click-rail": function (t) {
            ...
            function n(n) {
                ...
                if (!function (e, n, o) {
                    ...
                    e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (r ? i.scrollTop -= r * e.settings.wheelSpeed : i.scrollTop += a * e.settings.wheelSpeed, l = !0) : e.scrollbarXActive && !e.scrollbarYActive && (a ? i.scrollLeft += a * e.settings.wheelSpeed : i.scrollLeft -= r * e.settings.wheelSpeed, l = !0) : (i.scrollTop -= r * e.settings.wheelSpeed, i.scrollLeft += a * e.settings.wheelSpeed), b(e), (l = l || function (t, n) {
                        var o = Math.floor(i.scrollTop), a = 0 === i.scrollTop,
                            r = o + i.offsetHeight === i.scrollHeight, s = 0 === i.scrollLeft,
            ...
            if (g.supportsTouch || g.supportsIePointer) {
                var i = e.element, n = {}, o = 0, a = {}, r = null;
            ...
            function h(r) {
                if (u(r)) {
                    var d = c(r), h = {pageX: d.pageX, pageY: d.pageY}, p = h.pageX - n.pageX, f = h.pageY - n.pageY;
                    if (function (e, n, o) {
                        if (!i.contains(e)) return !1;
                        for (var a = e; a && a !== i;) {
                            if (a.classList.contains(s.element.consuming)) return !0;
                    ...
                    l(p, f), n = h;
                    var m = (new Date).getTime(), v = m - o;
                    v > 0 && (a.x = p / v, a.y = f / v, o = m), function (t, n) {
                        var o = Math.floor(i.scrollTop), a = i.scrollLeft, r = Math.abs(t), s = Math.abs(n);
                        if (s > r) {
        ...
        this.scrollbarXBottom = parseInt(h.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = v(h.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = v(h.borderLeftWidth) + v(h.borderRightWidth), e(this.scrollbarXRail, {display: "block"}), this.railXMarginWidth = v(h.marginLeft) + v(h.marginRight), e(this.scrollbarXRail, {display: ""}), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = i(s.element.rail("y")), n.appendChild(this.scrollbarYRail), this.scrollbarY = i(s.element.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", u), this.event.bind(this.scrollbarY, "blur", d), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
        ...
        }(this.scrollbarY) : null, this.railBorderYWidth = v(f.borderTopWidth) + v(f.borderBottomWidth), e(this.scrollbarYRail, {display: "block"}), this.railYMarginHeight = v(f.marginTop) + v(f.marginBottom), e(this.scrollbarYRail, {display: ""}), this.railYHeight = null, this.railYRatio = null, this.reach = {
    ...
    var e = function () {
        ...
        return i.getSelectedChip = function () {
            ...
            this.$chipsWrapper.on("keydown", function (e) {
                var i = e.which === t.keyCodes.backspace, n = e.which === t.keyCodes.delete,
                    o = e.which === t.keyCodes.arrowLeft, a = e.which === t.keyCodes.arrowRight;
            ...
            this.$chipsWrapper.on("keydown", "input", function (i) {
                var n = t(i.target), o = i.which === e.keyCodes.enter, a = i.which === e.keyCodes.comma,
                    r = i.which === e.keyCodes.backspace;
                if ((o || a) && !e.$autocompleteList.find("li").hasClass("selected")) return i.preventDefault(), e.addChip({tag: n.val()}), void n.val("");
            ...
            var e = this, i = this.$chipsWrapper.find(".chip-position-wrapper").find("input");
            i.on("keyup", function (n) {
                ...
                var a = n.which === e.keyCodes.enter, r = n.which === e.keyCodes.comma,
            ...
            this.$chipsWrapper.on("click", "li", function (i) {
                i.preventDefault();
                var n = t(i.target);
                e.addChip({tag: n.text()}), e.$chipsWrapper.find(".chip-position-wrapper").find("input").val(""), e.$autocompleteList.remove()
            })
        }, i.deleteSelectedChip = function () {
            var t = this.getSelectedChip(), e = t.siblings(".chip").length, i = t.index();
            this.deleteChip(i);
            var n = -1;
            ...
            var e = this.getSelectedChip(), i = e.index(), n = e.siblings(".chip").length, o = t ? i - 1 : i + 1;
            if (t && o < 0) o = this.$chipsWrapper.find(".chip").length - 1; else if (!t && o > n) return void this.$chipsWrapper.find("input").focus();
            ...
            key: "isPublicInterfaceCall", get: function () {
...
!function (t) {
    ...
    (function (t) {
        ...
        var u = navigator.userAgent.indexOf("MSIE ") > -1 || navigator.userAgent.indexOf("Trident/") > -1 || navigator.userAgent.indexOf("Edge/") > -1,
            d = function () {
                ...
                return !1
            }(), h = void 0, p = void 0, f = void 0, m = !1, v = !1;
        ...
        function x() {
            if (b.length) {
                ...
                var t = m || !y || y.width !== h || y.height !== p, e = v || t || !y || y.y !== f;
                m = !1, v = !1, (t || e) && (b.forEach(function (i) {
                    t && i.onResize(), e && i.onScroll()
                }), y = {width: h, height: p, y: f}), (0, s.default)(x)
            }
        }
        ...
        var w = !!t.ResizeObserver && new t.ResizeObserver(function (t) {
            ...
            for (var e = arguments[1], i = Array.prototype.slice.call(arguments, 2), n = t.length, o = 0, r = void 0; o < n; o++) if ("object" === (void 0 === e ? "undefined" : a(e)) || void 0 === e ? t[o].jarallax || (t[o].jarallax = new C(t[o], e)) : t[o].jarallax && (r = t[o].jarallax[e].apply(t[o].jarallax, i)), void 0 !== r) return r;
            return t
        };
            ...
            key: "parseURL", value: function (t) {
                var e, i, n, o,
                    ...
                    r = function (t) {
                        ...
                        return !(!e || !e[3]) && e[3]
                    }(t), s = (i = t.split(/,(?=mp4\:|webm\:|ogv\:|ogg\:)/), n = {}, o = 0, i.forEach(function (t) {
        ...
        return i.init = function () {
            ...
            this.$input.on("keyup", function (e) {
                ...
                if (t.$autocompleteWrap.empty(), i.length) {
                    ...
                    var n = t.$autocompleteWrap, o = t.$autocompleteWrap.find("li"), a = o.eq(t.count).outerHeight(),
            ...
            for (var n in e) if (-1 !== e[n].toLowerCase().indexOf(i.toLowerCase())) {
                var o = t("<li>" + e[n] + "</li>");
    ...
    t.fn.mdbTreeview = function () {
        ...
        e.hasClass("treeview") && function (e) {
            ...
            var i = e.find(".treeview-animated-element"), n = e.find(".closed");
            e.find(".nested").hide(), n.off("click"), n.on("click", function () {
                var e = t(this), i = e.siblings(".nested"), n = e.children(".fa-angle-right");
            ...
            var i = e.find(".treeview-colorful-element"), n = e.find(".treeview-colorful-items-header");
            e.find(".nested").hide(), n.off("click"), n.on("click", function () {
                var e = t(this), i = e.siblings(".nested"), n = e.children(".fa-plus-circle"),
    ...
    var t = {
        ...
        var i = "", n = e.parentNode.querySelector(t.CUSTOMFILELABEL);
        return n && (i = n.innerHTML), i
    }, i = function (t) {
        if (t.childNodes.length > 0) for (var e = [].slice.call(t.childNodes), i = 0; i < e.length; i++) {
            var n = e[i];
            if (3 !== n.nodeType) return n
        }
        return t
    }, n = function (e) {
        var n = e.bsCustomFileInput.defaultText, o = e.parentNode.querySelector(t.CUSTOMFILELABEL);
        o && (i(o).innerHTML = n)
    }, o = !!window.File, a = function (t) {
